...
# Kullanim: .\build_msix.ps1  [-Version 1.2.4.0] [-LayoutOnly] [-SkipSign]
#
# Store, surumun 4. bolumunun (revision) 0 olmasini ister: 1.2.4.0 (1.2.0.3 degil).

param(
    [string]$PackageName = "",
    [string]$Publisher = "",
    [string]$PublisherDisplayName = "",
    [string]$Version = "1.2.4.0",
    [switch]$SkipSign,
    [switch]$LayoutOnly
)
