...
_STRINGS: dict[str, dict[str, str]] = {
    "tr": {
        ...
        "users_applied_text": "Alt kullanıcı ve izin değişiklikleri uygulandı. Kasaya kalıcı yazmak için Kaydet\u2019e basın.",
        "user_pwd_repeat": "Kullanıcı {n} tekrar:",
        "perm_section": "Alt Kullanıcı izinleri (tüm alt kullanıcılar için ortak)",
        "perm_none": "Göremez",
        "perm_read": "Görür",
        ...
        "users_info": "Her alt kullanıcının kendi izinleri vardır (İsim, Bilgiler ve genel yetkiler kartın içindedir). Kaydet ile kasaya yazılır.",
    ...
    "en": {
        ...
        "users_applied_text": "Sub-user and permission changes were applied. Press Save to write them to the vault.",
        "user_pwd_repeat": "User {n} repeat:",
        "perm_section": "Sub-user permissions (shared by all sub-users)",
        "perm_none": "Hidden",
        "perm_read": "View",
        ...
        "users_info": "Each sub-user has their own permissions (Name, Info fields and general rights inside the card). Save vault to apply.",
