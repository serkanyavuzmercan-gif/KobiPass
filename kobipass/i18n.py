...
_STRINGS: dict[str, dict[str, str]] = {
    "tr": {
        ...
        "btn_save": "Kaydet",
        "btn_add_record_tip": "Listenin sonuna yeni kayıt ekler (aşağı inmene gerek yok)",
        "btn_reveal_all": "Gözleri Aç",
        "btn_reveal_all_tip": "Tüm satırlardaki şifreleri 10 saniyeliğine gösterir",
        "reveal_all_active": "Şifreler {sec} sn görünür",
        "btn_clear": "Temizle",
        ...
        "status_unsaved_short": "Kaydedilmedi",
        "status_role": "{role}",
        ...
        "row_scroll_next": "Sonraki bilgi alanları (Shift + tekerlek)",
        "row_scroll_prev": "Önceki bilgi alanları (Shift + tekerlek)",
        "row_scroll_tip": "Alanlar arasında kaydırın (Shift + tekerlek)",
        ...
        "tab_add_tip": "Yeni sekme ekle",
        "tab_rename": "Yeniden adlandır",
        "tab_toggle_hidden": "Gizli sekme yap / normal yap",
        "tab_delete": "Sekmeyi sil",
        "tab_hidden_tip": "Gizli sekme — yalnızca yönetici görür",
        "tab_rename_title": "Sekmeyi yeniden adlandır",
        "tab_rename_label": "Sekme adı:",
        "tab_default_name": "Sekme",
        "tab_new_name": "Sekme ({n})",
        "tab_delete_title": "Sekmeyi sil",
        "tab_delete_text": "'{name}' sekmesi ve içindeki tüm kayıtlar silinsin mi?",
        "tab_cannot_delete_last": "Son sekme silinemez; kasada en az bir sekme kalmalı.",
        "tab_delete_needs_empty": "Bu sekmede kayıt var. Sekmeyi silmek için önce içindeki tüm kayıtları tek tek kaldırın.",
        "tab_cannot_hide_last": "Son görünür sekme gizlenemez; alt kullanıcıların görebileceği en az bir normal sekme kalmalı.",
        "tab_made_hidden": "'{name}' artık gizli sekme (yalnızca yönetici görür).",
        "tab_made_normal": "'{name}' artık normal sekme.",
        "summary_title": "KAYIT ÖZETİ",
        "summary_collapse": "Özet panelini gizle",
        "summary_expand": "Özet panelini göster",
        "summary_total_rows": "Toplam Satır",
        "summary_total_cells": "Toplam Değer Hücresi",
        "summary_last_access": "Son Erişim",
        ...
        "err_save_io": "Dosya yazılamadı. Başka bir program (yedekleme/antivirüs) dosyayı kullanıyor olabilir; birkaç saniye sonra tekrar deneyin.\n\nAyrıntı: {error}",
        ...
        "denied_retry": "Parola hatalı. Kalan deneme hakkı: {remaining}.",
        "denied_lockout": "Üç kez hatalı parola girildi. Güvenlik gereği program kapatılıyor. Programı yeniden açıp tekrar deneyebilirsiniz.",
        ...
        "pwd_user_required": "\"{name}\" için parola girilmelidir.",
        ...
        "audit_field_removed": "{field} hücresi silindi (sonrakiler sola kaydı)",
        ...
        "search_placeholder": "Tüm alanlarda ara (isim, parolalar, notlar)...",
        "search_no_results": "“{term}” için sonuç bulunamadı.",
        ...
        "import_csv_first_row_header": "İlk satır başlık (kolon adları)",
        ...
        "import_csv_done": "{count} kayıt aktif sekmeye eklendi. Değişiklikleri kalıcı kılmak için Kaydet'e basmayı unutmayın.",
        "row_icon_add": "Logo ekle",
        "row_icon_change": "Logoyu değiştir",
        "row_icon_remove": "Logoyu kaldır",
        "row_icon_filter": "Görseller (*.png *.jpg *.jpeg *.bmp *.webp *.ico);;Tüm dosyalar (*)",
        "row_icon_invalid": "Geçerli bir görsel seçilemedi.",
        "shortcut_ask_title": "Masaüstü kısayolu",
        "shortcut_ask_text": "KobiPass için masaüstüne bir kısayol eklensin mi?",
        "shortcut_done_title": "Kısayol eklendi",
        "shortcut_done_text": "Masaüstüne KobiPass kısayolu eklendi.",
        "shortcut_fail_title": "Kısayol eklenemedi",
    ...
    "en": {
        ...
        "btn_save": "Save",
        "btn_add_record_tip": "Adds a new record at the end of the list (no need to scroll down)",
        "btn_reveal_all": "Reveal All",
        "btn_reveal_all_tip": "Shows every password for 10 seconds",
        "reveal_all_active": "Passwords visible for {sec} s",
        "btn_clear": "Clear",
        ...
        "status_unsaved_short": "Not saved",
        "status_role": "{role}",
        ...
        "row_scroll_next": "Next info fields (Shift + wheel)",
        "row_scroll_prev": "Previous info fields (Shift + wheel)",
        "row_scroll_tip": "Scroll through fields (Shift + wheel)",
        ...
        "tab_add_tip": "Add a new tab",
        "tab_rename": "Rename",
        "tab_toggle_hidden": "Make hidden / make normal",
        "tab_delete": "Delete tab",
        "tab_hidden_tip": "Hidden tab — only the admin can see it",
        "tab_rename_title": "Rename tab",
        "tab_rename_label": "Tab name:",
        "tab_default_name": "Sheet",
        "tab_new_name": "Sheet ({n})",
        "tab_delete_title": "Delete tab",
        "tab_delete_text": "Delete tab '{name}' and all its records?",
        "tab_cannot_delete_last": "Cannot delete the last tab; the vault must keep at least one.",
        "tab_delete_needs_empty": "This tab contains records. To delete the tab, first remove all of its records one by one.",
        "tab_cannot_hide_last": "Cannot hide the last visible tab; at least one normal tab must remain for sub-users.",
        "tab_made_hidden": "'{name}' is now a hidden tab (admin only).",
        "tab_made_normal": "'{name}' is now a normal tab.",
        "summary_title": "RECORD SUMMARY",
        "summary_collapse": "Hide summary panel",
        "summary_expand": "Show summary panel",
        "summary_total_rows": "Total Rows",
        "summary_total_cells": "Total Value Cells",
        "summary_last_access": "Last Access",
        ...
        "err_save_io": "Could not write the file. Another program (backup/antivirus) may be using it; wait a few seconds and try again.\n\nDetail: {error}",
        "saved_title": "Saved",
        "saved_text": "Vault file saved:\n{path}",
        "denied_title": "Access denied",
        "denied_text": "Wrong password or corrupted file. Content is not shown.",
        "denied_retry": "Wrong password. Attempts remaining: {remaining}.",
        "denied_lockout": "Wrong password entered three times. The program is closing for security. You may reopen it and try again.",
        ...
        "pwd_user_required": "A password is required for \"{name}\".",
        ...
        "audit_field_removed": "{field} cell removed (later cells shifted left)",
        ...
        "search_placeholder": "Search all fields (name, passwords, notes)...",
        ...
        "import_csv_first_row_header": "First row is a header (column names)",
        ...
        "import_csv_done": "{count} records were added to the active tab. Remember to press Save to persist the changes.",
        "row_icon_add": "Add logo",
        "row_icon_change": "Change logo",
        "row_icon_remove": "Remove logo",
        "row_icon_filter": "Images (*.png *.jpg *.jpeg *.bmp *.webp *.ico);;All files (*)",
        "row_icon_invalid": "Could not load a valid image.",
        "shortcut_ask_title": "Desktop shortcut",
        "shortcut_ask_text": "Add a KobiPass shortcut to the desktop?",
        "shortcut_done_title": "Shortcut added",
        "shortcut_done_text": "A KobiPass shortcut was added to the desktop.",
        "shortcut_fail_title": "Shortcut not added",
