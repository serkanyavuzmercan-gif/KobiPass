...
_STRINGS: dict[str, dict[str, str]] = {
    "tr": {
        ...
        "users_info": "Alt kullanıcı parolalarını, sayısını ve ortak izin şablonunu düzenleyin. Kaydet ile kasaya yazılır.",
    ...
    "en": {
        ...
        "users_info": "Edit sub-user passwords, count and the shared permission template. Save vault to apply.",
